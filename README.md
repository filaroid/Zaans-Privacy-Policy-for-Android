# 잔스(Zaans) 안드로이드 어플리케이션 개인정보 처리방침
...
쿠키 등 사용 목적: 회원의 접속 빈도나 접속 시간 등을 분석, 회원의 이용 시간, 이동 경로 파악 및 추적, 모바일 어플리케이션 항목 확인 횟수 파악 등을 통한 개인 맞춤 서비스를 제공하기 위해 사용합니다.
